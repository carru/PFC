...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.example.sensortagrx.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.example.sensortagrx.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.example.sensortagrx.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "com.example.sensortagrx.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA = "com.example.sensortagrx.EXTRA_DATA";
    public final static String SENSOR_TYPE = "com.example.sensortagrx.SENSOR_TYPE";
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        if (characteristic.getUuid().toString().equalsIgnoreCase(accelerometer.getDataUUID())) {
            ...
            intent.putExtra(SENSOR_TYPE, accelerometer.getName());
            sendBroadcast(intent);
