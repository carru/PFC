...
public abstract class Sensor {
	...
	public void setPeriod(BleService mBluetoothLeService, int period) {
	...
	public void enable(BleService mBleService) {
		BluetoothGattService service = 
				mBleService.getService(UUID.fromString(getServUUID()));
  		...
  		mBleService.writeCharacteristic(confCharacteristic, getEnableCode());
	}
	
	public void enableNotifications(BleService mBleService) {
		BluetoothGattService service = 
				mBleService.getService(UUID.fromString(getServUUID()));
		BluetoothGattCharacteristic dataCharacteristic = 
  		...
  		mBleService.setCharacteristicNotification(dataCharacteristic, true);
	}
